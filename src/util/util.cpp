...
void Util::printInformation(string header, string information, ostream &outputStream, PrettyConsole::Decoration header_decoration, PrettyConsole::Decoration information_decoration)
{
    ...
    outputStream << intermediate_stream.str();
}